...
export interface components {
	schemas: {
		...
		WorkerEventInput:
			| components["schemas"]["WorkerActivityEventInput"]
			| components["schemas"]["WorkerReadyEventInput"]
			| components["schemas"]["WorkerOutputEventInput"];
		WorkerOKResponse: {
			/** @constant */
			ok: true;
		};
		...
		WorkerTransportRequest:
			| components["schemas"]["WorkerWorkspaceListTransport"]
			| components["schemas"]["WorkerWorkspaceReadTransport"]
			| components["schemas"]["WorkerWorkspaceWriteTransport"]
			| components["schemas"]["WorkerWorkspaceDiffTransport"]
			| components["schemas"]["WorkerTerminalOpenTransport"]
			| components["schemas"]["WorkerTerminalInputTransport"]
			| components["schemas"]["WorkerTerminalResizeTransport"]
		...
		ClientEvent:
			| components["schemas"]["UserMessageEvent"]
			| components["schemas"]["AssistantDeltaEvent"]
			| components["schemas"]["TurnStartedEvent"]
			| components["schemas"]["TurnCompletedEvent"]
			| components["schemas"]["TurnInterruptedEvent"]
			| components["schemas"]["TurnAbortedEvent"]
			| components["schemas"]["InterruptRequestedEvent"];
		ClientEventPage: {
		...
		/** @enum {string} */
		WorkspaceFileStatus:
			"unmodified" | "modified" | "added" | "deleted" | "renamed" | "untracked" | "copied" | "changed";
		WorkspaceDiffFile: {
			path: string;
			oldPath?: string;
