...
export type GitHubUserAuthorizationStart = Schemas["GitHubUserAuthorizationStart"];
export type GitHubRepositoryAccessState = Schemas["GitHubRepositoryAccessState"];
...
export type CreateGitHubScratchProjectInput = Schemas["CreateGitHubScratchProjectInput"];
export type CreateGitHubScratchProjectResponse = Schemas["CreateGitHubScratchProjectResponse"];
...
export type PullRequestReviewCommentLink = Schemas["PullRequestReviewCommentLink"];
export type PullRequestUnresolvedReviewer = Schemas["PullRequestUnresolvedReviewer"];
export type PullRequestSubmittedReview = Schemas["PullRequestSubmittedReview"];
...
export type PullRequestMergeabilitySummary = Schemas["PullRequestMergeabilitySummary"];
...
export type RedactedProviderConnection = Schemas["RedactedProviderConnection"];
export type PutAgentProviderConnectionInput = Schemas["PutAgentProviderConnectionInput"];
...
export type WorkerCheckoutGrantResponse = Schemas["WorkerCheckoutGrantResponse"];
export type CreateWorkerChildInput = Schemas["CreateWorkerChildInput"];
export type SendMessageInput = Schemas["SendMessageInput"];
export type WorkerWorkspaceListPayload = Schemas["WorkerWorkspaceListPayload"];
export type WorkerWorkspaceReadPayload = Schemas["WorkerWorkspaceReadPayload"];
export type WorkerWorkspaceWritePayload = Schemas["WorkerWorkspaceWritePayload"];
export type WorkerWorkspaceEntryPage = Schemas["WorkerWorkspaceEntryPage"];
export type WorkerTerminalOpenPayload = Schemas["WorkerTerminalOpenPayload"];
export type WorkerTerminalInputPayload = Schemas["WorkerTerminalInputPayload"];
export type WorkerTerminalResizePayload = Schemas["WorkerTerminalResizePayload"];
export type WorkerTerminalClosePayload = Schemas["WorkerTerminalClosePayload"];
export type WorkerTerminalOpenResult = Schemas["WorkerTerminalOpenResult"];
export type WorkerTerminalInputResult = Schemas["WorkerTerminalInputResult"];
export type WorkerTerminalResizeResult = Schemas["WorkerTerminalResizeResult"];
export type WorkerTerminalCloseResult = Schemas["WorkerTerminalCloseResult"];
export type WorkerWorkspaceListTransport = Schemas["WorkerWorkspaceListTransport"];
export type WorkerWorkspaceReadTransport = Schemas["WorkerWorkspaceReadTransport"];
export type WorkerWorkspaceWriteTransport = Schemas["WorkerWorkspaceWriteTransport"];
export type WorkerWorkspaceDiffTransport = Schemas["WorkerWorkspaceDiffTransport"];
export type WorkerTerminalOpenTransport = Schemas["WorkerTerminalOpenTransport"];
export type WorkerTerminalInputTransport = Schemas["WorkerTerminalInputTransport"];
export type WorkerTerminalResizeTransport = Schemas["WorkerTerminalResizeTransport"];
export type WorkerTerminalCloseTransport = Schemas["WorkerTerminalCloseTransport"];
export type WorkerTransportRequest = Schemas["WorkerTransportRequest"];
export type WorkerClaimTransportResponse = Schemas["WorkerClaimTransportResponse"];
export type WorkerTransportResult = Schemas["WorkerTransportResult"];
export type WorkerCompleteTransportInput = Schemas["WorkerCompleteTransportInput"];
export type WorkerFailTransportInput = Schemas["WorkerFailTransportInput"];
export type WorkerAgentTerminalResponse = Schemas["WorkerAgentTerminalResponse"];
export type WorkerTerminalExitInput = Schemas["WorkerTerminalExitInput"];
export type WorkerTerminalOutputInput = Schemas["WorkerTerminalOutputInput"];
export type WorkerTerminalOutputResponse = Schemas["WorkerTerminalOutputResponse"];
