...
export const AGENT_INSTALLATION_STATES = ["installed", "not_installed", "unknown", "not_applicable"] as const;

export type AgentInstallationState = (typeof AGENT_INSTALLATION_STATES)[number];

export const AGENT_AUTHENTICATION_STATES = ["authorized", "unauthorized", "unknown", "not_applicable"] as const;
...
export function hasAgentCapability(profile: Pick<AgentProfile, "capabilities">, capability: AgentCapability): boolean {
