...
describe("agent capabilities", () => {
	...
	it("normalizes installation and authentication states", () => {
		expect(AGENT_INSTALLATION_STATES).toEqual(["installed", "not_installed", "unknown", "not_applicable"]);
		expect(AGENT_AUTHENTICATION_STATES).toEqual(["authorized", "unauthorized", "unknown", "not_applicable"]);
	});
});
