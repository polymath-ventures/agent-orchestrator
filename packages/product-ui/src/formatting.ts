export type RelativeTimeMessageKey = "time.justNow" | "time.minutesAgo" | "time.hoursAgo" | "time.daysAgo";

export type RelativeTimeTranslator = (key: RelativeTimeMessageKey, values?: Readonly<{ n: number }>) => string;
...
export function formatTimeCompact(isoDate: string | null | undefined, options: FormatTimeCompactOptions = {}): string {
