...
import { getNotifications, markAllNotificationsRead, markNotificationRead, type NotificationRecord } from "../lib/api";
				...
				<FlatList
					...
					ListEmptyComponent={
						<EmptyState
							...
							message={error ?? "Alerts about agents that need you and PRs that are ready will show up here."}
						/>
					}
