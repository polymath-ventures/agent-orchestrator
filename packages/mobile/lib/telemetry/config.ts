...
export const MOBILE_POSTHOG_HOST = process.env.EXPO_PUBLIC_POSTHOG_HOST?.trim() || "https://us.i.posthog.com";
 ...
 */
export const MOBILE_TELEMETRY_DISABLED = (process.env.EXPO_PUBLIC_AO_TELEMETRY_DISABLED ?? "").trim() === "1";
