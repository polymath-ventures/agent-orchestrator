...
export function createMobileConversationPageCache(weigh?: (page: ConversationPage) => number): ConversationPageCache {
...
export function cachedConversationState(
	cache: ConversationPageCache,
	key: string,
): {
