...
func TestMigration0068BackfillsExistingSessionsToTUI(t *testing.T) {
	db := openTestDB(t)
...
func TestMigration0068FreshDatabaseDefaultsToTUI(t *testing.T) {
	db := openTestDB(t)
	upTo(t, db, 68)
...
func TestMigration0068ConversationSchemaConstraints(t *testing.T) {
	db := openTestDB(t)
	upTo(t, db, 68)
