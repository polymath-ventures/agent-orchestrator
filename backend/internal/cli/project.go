...
func newProjectCommand(ctx *commandContext) *cobra.Command {
	...
	cmd.AddCommand(newProjectConfigCommand(ctx))
...
func newProjectSetConfigCommand(ctx *commandContext) *cobra.Command {
	...
	f.StringVar(&opts.agentRulesFile, "agent-rules-file", "", "Repo-relative or absolute file containing worker standing instructions")
	f.StringVar(&opts.orchestratorRules, "orchestrator-rules", "", "Project-specific standing instructions for orchestrator sessions")
	f.StringVar(&opts.orchestratorRulesFile, "orchestrator-rules-file", "", "Repo-relative or absolute file containing orchestrator standing instructions")
	f.StringVar(&opts.reviewerRules, "reviewer-rules", "", "Project-specific standing instructions for reviewer sessions")
	f.StringVar(&opts.reviewerRulesFile, "reviewer-rules-file", "", "Repo-relative or absolute file containing reviewer standing instructions")
	f.StringVar(&opts.primeRules, "prime-rules", "", "Project-specific standing instructions for prime sessions")
	f.StringVar(&opts.primeRulesFile, "prime-rules-file", "", "Repo-relative or absolute file containing prime standing instructions")
