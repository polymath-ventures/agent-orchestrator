...
var schemaNames = map[string]string{
	...
	"DomainSessionInitialContextDocument": "SessionInitialContextDocument",
	"DomainSessionInitialContextSegment":  "SessionInitialContextSegment",
	...
	"ControllersSessionInitialContextResponse":            "SessionInitialContextResponse",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/context", id: "getSessionInitialContext", tag: "sessions",
			summary:    "Inspect a session's launch context by source",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.SessionInitialContextResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
