...
import { FAQPageJsonLd, HomeWebPageJsonLd, OrganizationJsonLd } from "@/components/JsonLd";
...
const WallOfLoveSection = dynamic(() => import("./components/WallOfLoveSection").then((mod) => mod.WallOfLoveSection));
