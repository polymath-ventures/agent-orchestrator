...
export function DownloadButton({ size = "md", className = "" }: DownloadButtonProps) {
	...
	const sizeClasses = size === "sm" ? "h-8 px-3 text-sm" : "px-3 sm:px-6 py-2 sm:py-3 text-sm sm:text-base";
	...
	return (
		<Link href="/download" className={buttonClasses} onClick={() => track("download_clicked")}>
