...
function detectMacArch(): typeof Platform.MacAppleSilicon | typeof Platform.MacIntel {
	...
	try {
		...
		return renderer.toLowerCase().includes("apple") ? Platform.MacAppleSilicon : Platform.MacIntel;
	} catch {
...
export function isMacPlatform(platform: Platform): boolean {
	return platform === Platform.MacAppleSilicon || platform === Platform.MacIntel;
}
