...
export function formatContentDate(date: string, monthStyle: "short" | "long" = MONTH_SHORT): string {
...
export function normalizeContentDate(value: unknown, options: { fallbackToNow?: boolean } = {}): string | undefined {
