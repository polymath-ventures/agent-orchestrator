...
export const shortcutLabelKeys: Record<AppShortcutId, MessageKey> = {
	...
	"terminal-exit-focus": "shortcut.terminal-exit-focus",
	"toggle-browser-devtools": "shortcut.toggle-browser-devtools",
};
...
export type AgentSwitchErrorCode = NonNullable<components["schemas"]["ControllersAgentSwitchView"]["errorCode"]>;
