...
beforeEach(() => {
	...
	notificationQueryMock
		.mockReset()
		.mockImplementation((status: NotificationListStatus) =>
...
describe("NotificationCenter", () => {
	...
	it("normalizes legacy ready notifications without rewriting stored history", async () => {
		...
		expect(
			screen.getByText("PR from session Checkout flow is ready to merge. CI passed with no blocking review feedback."),
		).toBeInTheDocument();
