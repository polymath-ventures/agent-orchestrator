...
import { settingsDialogContentClass, settingsDialogFooterClass, settingsDialogHeaderClass } from "./ui/dialog";
			...
			<Dialog.Portal>
				...
				>
					...
					<div className={settingsDialogFooterClass}>
						...
						<Button type="button" variant="footer-primary" onClick={() => projectId && onRetry(projectId)}>
