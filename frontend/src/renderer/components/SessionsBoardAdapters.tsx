...
import { clearTerminateSessionState, useTerminateSessionState } from "../hooks/useTerminateSession";
...
export function BoardSessionCardAdapter({
	...
	return <DesktopSessionCard onOpen={onOpen} onTerminate={onTerminate} session={session} usage={usage} />;
}
...
function toUsagePresentation(usage: SessionUsageSummary | undefined, t: TFunction): BoardUsagePresentation | undefined {
