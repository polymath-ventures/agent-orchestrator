...
export const TurnPlan = memo(function TurnPlan({
	...
	return (
		<section aria-label="Agent plan" className="rounded-lg border border-border bg-surface" data-turn-plan="true">
			<div className="flex items-center gap-2 px-3.5 py-2.5">
				...
				{live && done < plan.steps.length ? (
					<Loader2 aria-label="still planning" className="size-3 shrink-0 animate-spin text-muted-foreground/60" />
				) : null}
