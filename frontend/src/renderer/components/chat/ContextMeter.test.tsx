...
describe("ContextMeter", () => {
	...
	describe("quota warning", () => {
		...
		it("warns on the tighter of the two windows", () => {
			render(
				<ContextMeter usage={usage()} rateLimits={limits({ primaryUsedPercent: 30, secondaryUsedPercent: 88 })} />,
			);
		...
		it("ignores a window the provider did not report", () => {
			render(
				<ContextMeter usage={usage()} rateLimits={limits({ primaryUsedPercent: -1, secondaryUsedPercent: -1 })} />,
			);
