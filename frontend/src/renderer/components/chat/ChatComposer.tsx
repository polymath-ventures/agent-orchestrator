	...
	return (
		...
		>
			...
			<div className="flex min-h-8 items-end justify-between gap-3">
				<div role="group" aria-label="Message tools" className="flex min-w-0 flex-1 flex-wrap items-center gap-1">
					{canAttach ? (
						<>
							<input
								ref={filePicker}
				...
				<div role="group" aria-label="Send message controls" className="flex shrink-0 items-center gap-2">
