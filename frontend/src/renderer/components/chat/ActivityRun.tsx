	...
	return (
		<div className="flex flex-col">
			...
			>
				...
				{failed > 0 ? <span className="text-[11px] text-destructive">{failed} failed</span> : null}
				{cancelled > 0 ? <span className="text-[11px] text-muted-foreground/70">{cancelled} stopped</span> : null}
