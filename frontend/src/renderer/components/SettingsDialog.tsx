...
export function SettingsDialog() {
	...
	const projectSections: Array<{ id: ProjectSettingsSection; label: string; icon: typeof Settings2 }> = [
		...
		{ id: "instructions", label: t("settings.project.instructions"), icon: ScrollText },
		{ id: "workers", label: t("settings.project.workers"), icon: SlidersHorizontal },
						...
						<div className="flex h-full min-h-0">
							...
							<div className="flex min-w-0 flex-1 flex-col bg-popover">
								<DialogHeader
									className={cn(
										settingsDialogHeaderClass,
										"flex h-auto shrink-0 flex-row items-center justify-between",
									)}
								>
