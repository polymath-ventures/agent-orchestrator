...
const expectedNode =
	process.platform === "win32" ? join(outDir, "node", "node.exe") : join(outDir, "node", "bin", "node");
const expectedAdapter = join(outDir, "node_modules", "@agentclientprotocol", "claude-agent-acp", "dist", "index.js");
