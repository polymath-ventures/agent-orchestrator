...
- [x] 1.1 Add domain tests for safe readable-label normalization, fallback behavior, separators, and preservation without a second label-length budget
...
- [x] 3.3 Wire tmux create/lookup/attach/restart/destroy to the same stored namespace key and prove long safe handles remain verbatim while invalid-character fallback stays deterministic
...
- [x] 4.3 Exercise new worker creation against real git worktrees and tmux, confirming long readable handles and collision-safe distinctness
