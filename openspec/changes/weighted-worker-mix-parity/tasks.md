...
- [x] 7.4 Update the PR body with the history-mined edge-case checklist, citing implementation file:line evidence or explicit non-applicability for each item.
