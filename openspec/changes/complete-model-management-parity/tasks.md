...
- [x] 6.4 Run the repository's full CI commands, rebase on the fetched remote default branch, push the final head, and complete independent cross-family final review before declaring the PR merge-ready.
