# claude-acp-runtime Specification

## Purpose

Define how AO provisions, resolves, and diagnoses the Claude ACP runtime across Electron and supported non-Electron installations.
