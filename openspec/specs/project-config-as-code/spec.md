# project-config-as-code Specification

## Purpose

TBD - created by archiving change add-project-config-as-code. Update Purpose after archive.
...
argument SHALL exit as a usage error (exit code 2); a project the daemon does
not recognize SHALL surface the daemon error and exit nonzero.
